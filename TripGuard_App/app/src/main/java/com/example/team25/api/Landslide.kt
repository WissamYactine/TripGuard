...
private val baseUrl = "https://api01.nve.no/hydrology/forecast/landslide/v1.0.6/api"
 ...
 */
fun landslideWarningByMunicipality(municipalityNr: String, lang: Language, startDate: String,
 ...
 */
fun landslideGetMunicipalities(countyNr: String): List<Municipality>? {
